#
#  Be sure to run `pod spec lint SCPeriodicScrollView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.social_media_url   = "http://twitter.com/童世超"
  ...
  # s.public_header_files = "SCPeriodicScrollView/Source/*.h"
